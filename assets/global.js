...
// stycky add to cart button 

const add_btn = document.querySelector(".custom_btn");
if(add_btn){
...
// add customm quantity 

// document.querySelectorAll("quantity-input").forEach((box) => {
//   const minusBtn = box.querySelector(".quantity__button.minus");
//   const plusBtn = box.querySelector("[name='plus']");
//   const input = box.querySelector(".quantity__input");
//   const minQty = parseInt(input.getAttribute("data-min")) || 1;

//   function updateButtons() {
//     const qty = parseInt(input.value) || minQty;
...
//     input.value = Math.max(minQty, parseInt(input.value));
//     updateButtons();
//   });
